<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="TestGrid.aspx.cs" Inherits="Welcome2Deloitte.TestGrid" %>
                        ...
                        <div class="row">  
                            <div class="col-lg-12 ">  
                                <div class="table-responsive">  
                                    <asp:GridView ID="grdCustomer" AllowPaging="true" AlternatingRowStyle-BackColor="WhiteSmoke"  runat="server" Width="80%" CssClass="table table-striped table-bordered table-hover"  DataKeyNames="Requisition NO" EmptyDataText="There are no data records to display." AlternatingRowStyle-BorderStyle="Solid"  PagerSettings-Mode="NextPrevious" PagerStyle-BorderStyle="Solid" ViewStateMode="Inherit" AutoGenerateColumns="False" OnPageIndexChanging="grdCustomer_PageIndexChanging">  
                                        <Columns>  
